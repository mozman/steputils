/*
License: MIT License
Based on: https://github.com/hypar-io/IFC-gen/blob/IFC4/grammar/Express.g4
Author: Ian Keough
...
actualParams
	: '(' parameter (',' parameter)* ')'
	;
	// IFC Named parameters. Ex: -- Axis1 IfcRepresentationItem() || IfcGeometricRepresentationItem() || IfcDirection([-1., 0.])
	// mozman: in IFC4x2.exp this 'named paramters' are just tailRemarks in a seprate line
	// see line 7315: IfcCartesianTransformationOperator(...)
	// and ther is no definition in the actual EXPRESS BFN file for 'named parameters'
